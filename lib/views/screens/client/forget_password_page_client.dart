...
class ForgetPasswordClient extends StatelessWidget {
  ForgetPasswordClient({super.key});
  
  static const pageRoute = "/client_forget_password_page";
        ...
        body: BlocConsumer<ForgotPasswordCubit, ForgotPasswordState>(
          listener: (context, state) {
            if (state is ResetCodeSent) {
              ...
              Navigator.pushNamed(context, NewPasswordClient.pageRoute);
...
/* 
 class ForgetPasswordClient extends StatefulWidget {
  const ForgetPasswordClient({super.key});

  static const pageRoute = "/client_forget_password_page";

  @override
  State<ForgetPasswordClient> createState() => _ForgetPasswordClientState();
}

class _ForgetPasswordClientState extends State<ForgetPasswordClient> {
