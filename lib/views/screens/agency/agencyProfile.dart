...
class AgencyScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    context.read<AgencyBloc>().add(FetchPublicAgencyById(agencyId!));
    return BlocBuilder<AgencyBloc, AgencyState>(
      builder: (context, state) {
        ...
        if (state is AgencyLoading) {
          ...
          final agencyModel = state.agency!;
          return Scaffold(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: NetworkImage(agencyModel.backGroundAgency ?? ''),
                    fit: BoxFit.cover,
                  ),
                ),
                child: Stack(
          ...
          child: Column(
            children: [
              CircleAvatar(
                ...
                backgroundImage: agencyModel.profilePictureAgency != null
                    ? NetworkImage(agencyModel.profilePictureAgency!)
                    : null,
                child: agencyModel.profilePictureAgency == null
                    ? Container(
                        decoration: BoxDecoration(
